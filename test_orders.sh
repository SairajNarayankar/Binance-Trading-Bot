#!/bin/bash
# Test script for placing various orders on Binance Futures Testnet
# This script demonstrates all order types and validates the bot functionality
